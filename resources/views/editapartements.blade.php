            ...
            <div class="flex flex-col gap-6 p-6 sm:p-10 rounded-2xl shadow-lg border border-black bg-white">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input value="{{$item->start_date}}"
                        type="date" name="start_date" class="border border-neutral-800 rounded-lg px-2 py-2 w-full">
                </div>

                <div class="flex flex-col gap-1.5">
                    <label for="end_date">Date de fin :</label>
                    <input value="{{$item->end_date}}"
                        type="date" name="end_date" class="border border-neutral-800 rounded-lg px-2 py-2 w-full">
                </div>
