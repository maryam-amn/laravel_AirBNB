    ...
    <div class="min-h-screen bg-gradient-to-tr from-blue-50 to-white py-6 px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6">
                ...
                <div class="flex flex-col justify-center items-center bg-white shadow-md p-4 rounded-xl hover:shadow-lg transition">
                    ...
                    <p class="text-center text-xs text-gray-600">du {{ \Carbon\Carbon::parse($appartement->start_date)->translatedFormat('d. F Y') }}
                        au {{ \Carbon\Carbon::parse($appartement->end_date)->translatedFormat('d. F Y') }}
                    </p>
                    <p class="text-center text-xs text-gray-600">Prix: {{$appartement-> price_per_day}} .- / nuit</p>
                    </a> </div>
                @endforeach
